...
<script type="text/javascript">
	...
	var address=$("#addSel").find("option:selected").text();
	$("#addr").val(address);
	}
...
<c:forEach items="${cartItemList }" var="cartItem">
	...
	<tr>
		<td colspan="6">
			 <input id="addr" type="text" style="display:none" name="address" value="甘肃省兰州市安宁区安宁西路甘肃政法学院${sessionScope.sessionUser.loginname}收"/>
			<select id="addSel" style="height:32px;width:500px" name="address" onchange="changeAddress()" >
					  <option value ="addr1">甘肃省兰州市安宁区安宁西路甘肃政法学院${sessionScope.sessionUser.loginname}收</option>
					  <option value ="addr2">北京市海淀区辉煌国际大厦20楼兴竹同智${sessionScope.sessionUser.loginname}收</option>
					  <option value="addr3">甘肃省庆阳市郭原乡郭原行政村西洼自然村${sessionScope.sessionUser.loginname}收</option>
			</select>
		</td>
	</tr>
	<tr>
